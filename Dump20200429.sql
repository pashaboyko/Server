...
INSERT INTO `product_features_value` VALUES (1,'0',1,1,3,10),(2,'1',1,2,3,9),(3,'1',5,3,2,7),(4,'0',5,4,2,5),(5,'40',2,5,1,2),(6,'42',2,6,1,1),(7,'1',6,7,4,15),(8,'0',6,8,4,14),(9,'красный',3,5,1,2),(10,'синий',3,6,1,1),(11,'ж',4,5,1,2),(12,'м',4,6,1,3),(13,'1',1,13,NULL,NULL),(14,'Оранжевый',3,14,NULL,NULL),(15,'Мужской',4,14,NULL,NULL),(16,'38',2,14,NULL,NULL),(17,'1',5,15,NULL,NULL),(18,'1',6,16,NULL,NULL),(19,'1',6,17,NULL,NULL),(20,'0',1,NULL,NULL,NULL);
...
CREATE TABLE `product_value` (
  `id_product_value` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(45) DEFAULT NULL,
  ...
  `photo` varchar(45) DEFAULT '0.png',
...
INSERT INTO `product_value` VALUES (1,'кофе',644832819197,150,3,10,15,'0.png',0,'23.03.2020',0),(2,'йогурт',438233939273,30,3,9,13,'0.jpg',0,'23.03.2020',0),(3,'фотоаппарат',437628788237,5400,2,7,10,'0.jpg',0,'23.03.2020',0),(4,'смартфон',477343947478,8700,2,5,9,'0.jpg',0,'23.03.2020',0),(5,'рубашка',733749933993,400,1,2,1,'0.jpg',0,'23.03.2020',0),(6,'джинсы',2999300019547,600,1,1,4,'0.png',0,'23.03.2020',0),(7,'шампунь',636762719117,80,4,15,20,'0.jpg',0,'23.03.2020',0),(8,'спрей_для_окон',987654900020,60,4,14,21,'0.jpg',0,'23.03.2020',0),(9,'342',456,34,3,11,13,'0.png',0,'2020-04-16',23),(10,'342',345465,34,3,11,13,'0.png',0,'2020-04-16',23),(11,'342',5645,34,3,11,13,'0.png',0,'2020-04-16',23),(12,'Мясо',34,43,3,11,14,'0.png',0,'2020-04-04',34),(13,'Мясо',76543,43,3,11,14,'0.png',0,'2020-04-04',34),(14,'Пашот',453423,23,1,3,6,'0.png',0,'2020-04-03',23),(15,'авыа',12324,1,2,6,12,'0.png',0,'2020-04-03',43),(16,'вы',43223311,22,4,13,23,'0.png',0,'2020-04-04',5),(17,'32',22312,12,4,13,22,'0.png',0,'2020-04-04',231);
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `product_value_BEFORE_INSERT` BEFORE INSERT ON `product_value` FOR EACH ROW BEGIN
DECLARE z INT default 0;

SELECT product_subcategory.id_category INTO z FROM  product_subcategory
                          WHERE new.id_subcategory = product_subcategory.id_subcategory ;

if(z = 0)
then
 SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'invalid data';
END if;
set new.id_category = z;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `product_value_BEFORE_UPDATE` BEFORE UPDATE ON `product_value` FOR EACH ROW BEGIN
DECLARE z INT default 0;
...
INSERT INTO `user` VALUES (1,576879889088,'Анна','Сиренко','0676676767','12','secret',0),(2,933938937372,'Ольга','Кузьменко','0933333333',NULL,'secret',0),(3,6734856,'kldnsg','klsdfn','290348902',NULL,'sdfmkldsnf',0);
/*!40000 ALTER TABLE `user` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping events for database 'product_new1'
--

--
-- Dumping routines for database 'product_new1'
--
...
-- Dump completed on 2020-04-29 17:13:54
